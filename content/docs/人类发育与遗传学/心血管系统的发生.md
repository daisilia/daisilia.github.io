...
<!-- {% note info 重点 %} -->
<!-- 1. 简述 [心房的分隔](#心房的分隔)； -->
<!-- 2. [卵圆孔](?highlight=卵圆孔#心房的分隔)； -->
<!-- 3. 简述 [法洛四联症](#法洛四联症) 的构成及其形成原因； -->
<!-- {% endnote %} -->

## 原始心血管系统的建立

人胚第 2 周末，来自**卵黄囊**、体蒂和绒毛膜的**胚外中胚层**增殖分化形成的细胞索或团，称 ==血岛==（blood island）。
...
第 3 周，胚内和胚外血管相连，形成了由**心管**和动静脉组成的 ==胚胎早期血管通路==。
...
第 18\~19 天，==口咽膜头端中胚层== 形成**生心区**（心脏的原基），随后出现腔隙，称为
...
{% tabs tabs_心脏外形的建立,1 %}
<!-- tab BiliBili@ -->
<iframe src="//player.bilibili.com/player.html?aid=376238340&bvid=BV1ao4y1k7Eo&cid=355229820&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
<!-- endtab -->

<!-- tab YouTube@ -->
<iframe width="560" height="315" src="https://www.youtube.com/embed/a0qyagIgBPw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<!-- endtab -->
{% endtabs %}
...
{% asset_img "心脏外形演变.png" "心脏外形演变'心脏外形演变'" %}
...
{% tabs tabs_心脏的内部分隔,1 %}
<!-- tab BiliBili@ -->
<iframe src="//player.bilibili.com/player.html?aid=888674553&bvid=BV1hK4y1u7ZE&cid=355892945&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
<!-- endtab -->

<!-- tab YouTube@ -->
<iframe width="560" height="315" src="https://www.youtube.com/embed/8nw9N5-HPkE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<!-- endtab -->
{% endtabs %}
...
{% asset_img "膜性室间隔的形成.png" "膜性室间隔的形成'膜性室间隔的形成'" %}

##### 心球与动脉干的分隔

<div style='display:table'>
{% asset_img left "心球及动脉干的分隔.jpg" "心球及动脉干的分隔'心球及动脉干的分隔'" %}

心球和动脉干的心内膜组织局部增厚，分别形成一对螺旋状走位、相对生长的**心球嵴**和**肺动脉嵴**。嵴愈合后形成**主动脉肺动脉隔**（aortico-pulmonary septum）。将心球和动脉干分隔为*主动脉*和*肺动脉*（见左图[^2]）。
...
: 主要原因为 [主动脉肺动脉隔](?highlight=主动脉肺动脉隔#心球与动脉干的分隔) 偏移，导致肺动脉狭窄，同时使主动脉向右偏移而骑跨于两个心室。
...
{% asset_img "Tetralogy_of_Fallot.svg" "正常心脏（左）与法洛四联症患者的心脏'正常心脏（左）与法洛四联症患者的心脏'" %}
