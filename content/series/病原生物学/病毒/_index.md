...
lastmod: 2022-11-16T23:36:39+08:00
weight: 80
tags:
    - 病原生物学
    - 病毒学
...
- **持续性病毒感染**（persistent viral infection）：机体可携带潜伏病毒数月至数（十）年；可出现症状，也可不出现症状；引起慢性进行性疾病，并可称为重要的传染源。
    ...
    - **慢发病毒感染**（slow virus infection）/迟发（病毒）感染/长程感染：持续感染有很长的潜伏期，随后缓慢的发展成致死性疾病，如 **HIV** 和**痲疹病毒**的感染。儿童期感染[<mark>麻疹病毒</mark>]({{< relref "呼吸道感染病毒#麻疹病毒" >}})恢复后，极少数人于十余年后可发生<mark>亚急性硬化性全脑炎</mark>（<mark>SSPE</mark>）。
...
{{% tab type=default summary=朊粒 id=朊粒 %}}
