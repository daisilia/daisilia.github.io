...
lastmod: 2023-10-01T23:15:25+08:00
comments: true
math: false
weight: 120
tags:
...
- 端粒酶解决染色体末端复制问题
    ...
    - 构成和功能：
        - 端粒酶 RNA：提供 RNA 模版
        - 端粒酶逆转录酶：催化逆转录（RNA 指导的 DNA 聚合酶活性）
        - 端粒酶协同蛋白 1
    - 过程：
...
- **逆转录酶活性**：
    ...
    - DNA 指导的 DNA 聚合酶活性：DNA 指导的 DNA 聚合（**没有**校对活性）
- 逆转录的意义：
    - 遗传信息从 RNA 流动到 DNA
    - 发展了中心法则
    ...
    - 合成跨越损伤修复
        - SOS 修复
            - DNA pol Ⅳ、Ⅴ
                ...
                - 随机插入核苷酸进行合成
                - 跨越损伤后，新的 DNA 聚合酶从 DNA 链上脱离，再由原来的 DNA 聚合酶 III 继续复制
