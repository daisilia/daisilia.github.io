...
lastmod: 2023-09-27T23:44:19+08:00
comments: true
math: false
weight: 120
tags:
...
1. 复制起始和原核生物基本类似，*具体过程不详*。
    ...
    - 拓扑酶
    - 复制因子：RFA、RFC
    - **PCNA**：在复制的起始和延长中起到重要的作用
        - 类似于 DNA pol Ⅲ 的β亚基，在 RFC 的作用下结合于引物-模板
        - 使 DNA pol δ 获得持续合成的能力
        - 促进*核小体*生成
2. 延长发生 DNA 聚合酶转换：α和δ互相转换，转换频率高，**催化速度慢**，PCNA 全程多次发挥作用，**冈崎片段比原核生物要短**
