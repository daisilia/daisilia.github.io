...
lastmod: 2023-10-06T20:40:25+08:00
comments: true
math: false
weight: 44
tags:
...
2. AngⅡ（<mark>缩血管作用最强</mark>）：AngⅡ 的生理作用几乎都是通过激动 AT<sub>1</sub> 受体产生的。
    ...
    3. 对中枢神经系统的作用：
        1. <mark>使中枢对压力感受性反射的敏感性降低</mark>，<mark>交感缩血管中枢紧张加强</mark>；
...
1. 舒血管物质：一氧化氮（NO）、
    ...
    - 前列环素（PGI<sub>2</sub>）：
        ...
        - 作用：舒张血管和抑制血小板聚集。
    - <mark>内皮超极化因子</mark>：促进 Ca<sup>2+</sup> 依赖的 K 通道开放，<mark>使血管平滑肌细胞膜发生超极化</mark>，从而使血管舒张。
2. 缩血管物质：
...
- 生理意义：在血压发生一定程度的变化时，使某些器官的血流量能保持相对稳定。
分布：在**肾血管**特别明显，在脑、心、肝、肠系膜和骨骼肌的血管也能看到，但皮肤血管一般没有这种表现。
