...
lastmod: 2023-10-20T23:20:55+08:00
comments: true
math: false
weight: 93
tags:
...
简化眼模型由一个前后径为 20 mm 的单球面折光体所构成。入射光线仅在由空气进入球形界面时折射一次，折射率为 1.333。折射界面的曲率半径为 5 mm，即节点在折射界面后方 5 mm 处，后主焦点恰好位于该折光体的后极，相当于人眼视网膜的位置。
...
- 视锥细胞：
    - 呈圆锥状，胞内有类似的膜盘结构
    - 含有三种不同的视色素,统称为视锥色素,分别存在于不同的视锥细胞中
    - 产生光感、色觉的物质基础
...
- 在暗环境中主要存在两种电流
    - Na+
        - 经过外段膜中的cGMP门控阳离子通道(主要允许Na+通透,也允许少量Ca2+通透)内流而产生,可使膜发生去极化
        - 在暗处,胞质内的cGMP浓度较高,能维持cGMP门控通道处于开放状态,产生稳定的内向电流,称为暗电流
    - K+
...
- 暗适应：当人长时间在明亮环境中突然进入暗处时,最初看不清任何东西,经过一定时间后,视觉敏感度才逐渐增高而看清在暗处的物体,这种现象称为暗适应
    ...
    - 经过一段时间后：视紫红质合成逐渐增多，对暗光的敏感度逐渐提高，恢复在暗处的视觉
    - 视觉阈经过两次下降期：
