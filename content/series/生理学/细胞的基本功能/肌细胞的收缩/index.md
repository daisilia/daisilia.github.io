...
lastmod: 2023-09-19T11:57:46+08:00
comments: true
math: false
weight: 24
tags:
...
{{< figure src="骨骼肌的肌原纤维和肌管系统.png" img-width="500px" title="骨骼肌的肌原纤维和肌管系统" caption="A：暗带（*粗肌丝全长*）；H：暗带中的 H 带；M：暗带中的 M 线；I：明带（细肌丝不与粗肌丝重合的长度）；Z：明带中、分隔肌节的 Z 线（Z 盘）" alt="骨骼肌的肌原纤维和肌管系统" id="fig_骨骼肌的肌原纤维和肌管系统" >}}
...
后负荷增大时，<mark>肌肉产生的张力增大</mark>，而<mark>缩短的速度减慢</mark>。关于横桥周期，后负荷增大时，横桥摆动速度减慢［这也巧妙地使更多的横桥同时处于与肌动蛋白结合的状态（图中黑色横桥）以维持张力］，横桥周期延长。
