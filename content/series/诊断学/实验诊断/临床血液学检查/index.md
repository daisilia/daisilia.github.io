...
{{% table title="红细胞和血红蛋白参考范围" id="tbl_红细胞和血红蛋白参考范围"  %}}
| 人群     | 血红蛋白浓度 | 红细胞计数                   |
|----------|--------------|------------------------------|
...
{{% table title="通过 Hb 浓度判断贫血程度" id="tbl_通过 Hb 浓度判断贫血程度"  %}}
| 贫血程度 |   男性  |   女性  |
|:--------:|:-------:|:-------:|
|   轻度   | 91～120 | 91～110 |
|   中度   |  61～90 |   同←   |
...
{{% table title="用红细胞平均指数分类贫血" id="tbl_用红细胞平均指数分类贫血"  %}}
| 贫血类型       | MCV   | MCH  | MCHC     |
|----------------|-------|------|----------|
| 大细胞性       | \>100 | \>34 | 316～354 |
| 小细胞性       | \<82  | \<27 | 316～354 |
...
{{% table title="白细胞分类计数" id="tbl_白细胞分类计数"  %}}
...
{{% table title="MPV 用于区分血小板减少的原因" id="tbl_MPV 用于区分血小板减少的原因"  %}}
| 血小板减少的原因   | MPV  |
|--------------------|------|
| 骨髓造血功能受损   | 减小 |
| 外周血血小板的破坏 | 增大 |
...
{{< figure src="红细胞形状异常.png" title="红细胞形状异常" alt="红细胞形状异常" id="fig_红细胞形状异常" >}}
...
{{< figure src="骨髓涂片.png" title="骨髓涂片" alt="骨髓涂片" id="fig_骨髓涂片" >}}
