...
```{r, "control-repeat by while", fig.cap=""}
v <- c("Google", "Runoob")
cnt <- 2
...
```{r, "function-lazy compute", error = TRUE}
f <- function(a, b) {
    print(a^2)
    print(a)
